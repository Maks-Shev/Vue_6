...
.container_nav, .container_baner, .container_project, .container_block_project, .blog_container, .container_latest_post, footer {
    margin: 0 auto;
    max-width: 1200px;
}
ul li {
...
.sub_content_project h3 {
    font-family: DM-serif;
    font-size: 25px;
    font-weight: 400;
    color: #292F36;
}
.sub_content_project span {
    font-family: Jost-Regular;
    font-size: 22px;
    font-weight: 400;
    color: #4D5053;
...
.content_latest_post_right_down {
    margin-top: 41px;
    display: flex;
    align-items: center;
    justify-content: space-between;
...
.blog_item_news:hover {
    background-color: #F4F0EC;
}
.blog_item_news:hover a {
    background-color: #ffffff;
}
.page_block {
    display: flex;
